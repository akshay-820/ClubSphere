...
export default function AdminCollegeRequestsPage() {
    ...
    useEffect(() => {
        // fetchRequests() calls setLoading(true) synchronously the moment it's
        // invoked, and React warns about setState calls that happen directly
        // (synchronously) in an effect body. Deferring the call to a microtask
        // moves the setState calls out of the synchronous effect body while
        // still running immediately after the current render commits.
        ...
        <DashboardLayout>
            ...
            <div className="mb-6">
                ...
                <p className="text-sm text-[#8888aa] mt-0.5">
                    Review and approve or reject pending college creation
                    requests.
                </p>
            </div>
