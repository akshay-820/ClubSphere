    ...
    const handleSave = async (e) => {
        ...
        try {
            ...
            if (avatarFile) {
                ...
                if (form.branch.trim()) fd.append("branch", form.branch.trim());
                if (form.year !== "")
                    fd.append("year", String(parseInt(form.year)));
                fd.append("avatar", avatarFile);

                res = await api.patch("/users/me", fd, {
            ...
            <div className="relative overflow-hidden rounded-2xl border border-[#1e1e3a] mb-6">
                ...
                <div className="relative p-8 flex flex-col sm:flex-row items-start sm:items-center gap-6">
                    ...
                    <div className="relative flex-shrink-0">
                        {editing ? (
                            ...
                            <>
                                ...
                                <div
                                    className={`absolute -bottom-1 -right-1 w-4 h-4 rounded-full border-2 border-[#13131f] ${user?.email_verified ? "bg-green-400" : "bg-red-400"}`}
                                />
                            </>
                        )}
                    </div>
                    ...
                    <div className="flex-1 min-w-0">
                        <h1 className="text-2xl font-bold text-[#f0f0ff] mb-0.5">
                            {user?.name}
                        </h1>
                        <p className="text-sm text-[#8888aa] flex items-center gap-1.5 mb-3">
                            ...
                            {user?.email}
                            {user?.email_verified ? (
                                <span className="ml-1 inline-flex items-center gap-1 text-xs text-green-400">
                    ...
                    <form onSubmit={handleSave} className="space-y-4 mt-4">
                        ...
                        {avatarFile && (
                            <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-blue-500/10 border border-blue-500/20 text-xs text-blue-300">
                                ...
                                Avatar ready — will be uploaded when you save.
                            </div>
                        )}
